...
const WalletManageForAdmin = () => {
    ...
    const fetchWalletData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://multicourseserver.onrender.com/api/wallet/show-wallet-admin",
          {
            headers: {
  ...
  const fetchWithdrawalRequests = async () => {
    ...
    try {
      const response = await axios.get(
        "https://multicourseserver.onrender.com/api/wallet/all-withdrawal-requests",
        {
          headers: {
  ...
  const handleApprove = async () => {
    try {
      const response = await axios.put(
        "https://multicourseserver.onrender.com/api/wallet/approve-withdrawal-request",
  ...
  const handleReject = async () => {
    try {
      const response = await axios.put(
        "https://multicourseserver.onrender.com/api/wallet/reject-withdrawal-request",
        { withdrawalId: modalData.withdrawal_id },
        {
          headers: {
            "Content-Type": "application/json",
