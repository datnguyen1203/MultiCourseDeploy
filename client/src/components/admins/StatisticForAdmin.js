...
const StatisticForAdmin = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      await Promise.all([
        fetchData("https://multicourseserver.onrender.com/api/orders/revenue", (data) =>
          setTotalRevenue(data.totalRevenue)
        ),
        fetchData("https://multicourseserver.onrender.com/api/orders/revenue-day", (data) =>
          setRevenueToday(data.totalRevenueToday)
        ),
        fetchData("https://multicourseserver.onrender.com/api/orders/revenue-year", (data) =>
          setRevenueYear(data.totalRevenueThisYear)
        ),
        fetchData("https://multicourseserver.onrender.com/api/orders/revenue-each-month", setMonthlyRevenue),
        fetchData("https://multicourseserver.onrender.com/api/orders/all-orders", (data) => {
          setOrders(data);
