    ...
    const fetchStatistics = async () => {
      try {
        ...
        const [courseRes, monthRes, todayRes, yearRes] = await Promise.all([
          ...
          axios.get("https://multicourseserver.onrender.com/api/orders/revenue-month-tutor", {
            headers,
          }),
          axios.get("https://multicourseserver.onrender.com/api/orders/revenue-day-tutor", {
            headers,
          }),
          axios.get("https://multicourseserver.onrender.com/api/orders/revenue-year-tutor", {
            headers,
          }),
        ]);
