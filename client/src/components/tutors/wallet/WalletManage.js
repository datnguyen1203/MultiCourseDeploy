...
const WalletManage = () => {
  ...
  const fetchWithdrawHistory = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        "https://multicourseserver.onrender.com/api/wallet/requests-history",
        {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      try {
        const response = await fetch(
          "https://multicourseserver.onrender.com/api/wallet/show-balance",
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleWithdraw = async () => {
    ...
    try {
      const response = await fetch(
        "https://multicourseserver.onrender.com/api/wallet/withdrawal-request",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdateBank = async () => {
    ...
    try {
      const response = await fetch(
        "https://multicourseserver.onrender.com/api/users/update-bank-account",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
