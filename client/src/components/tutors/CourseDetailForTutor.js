...
const CourseDetailForTutor = () => {
    ...
    const fetchStudents = async () => {
      try {
        const response = await fetch(
          `https://multicourseserver.onrender.com/api/progress/students/${courseId}`,
          {
            method: "GET",
            headers: {
  ...
  const handleDeleteLesson = async () => {
    ...
    try {
      await axios.delete(
        `https://multicourseserver.onrender.com/api/lessons/${selectedLesson._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteExam = async () => {
    ...
    try {
      await axios.delete(
        `https://multicourseserver.onrender.com/api/exams/delete-exam/${exams._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    const fetchCourseDetail = async () => {
      ...
      try {
        const courseResponse = await axios.get(
          `https://multicourseserver.onrender.com/api/courses/detail/${courseId}`,
        ...
        const examResponse = await fetch(
          `https://multicourseserver.onrender.com/api/exams/get-exam/${courseId}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
        ...
        const incomeResponse = await axios.get(
          `https://multicourseserver.onrender.com/api/orders/total-earning-from-course`,
          { headers: { Authorization: `Bearer ${token}` } }
        );
          ...
          <div className="space-y-8 max-w-7xl mx-auto">
            ...
            >
              <div className="flex flex-col items-center">
                <Title
                  level={1}
                  className={`text-center mb-6 ${isDarkMode ? "text-white" : ""
                    }`}
                >
                  {course.title}
                </Title>
                ...
                <Paragraph
                  className={`text-center max-w-3xl mx-auto mb-8 text-lg ${isDarkMode ? "text-gray-300" : ""
                    }`}
                >
                  {course.description}
                </Paragraph>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full max-w-4xl mt-8">
                  <Card
                    className={`w-full md:w-1/2 ${isDarkMode
                  ...
                  {course.comments && course.comments.length > 0 && (
                    <Card
                      className={`w-full md:w-1/2 ${isDarkMode ? "bg-gray-700" : "bg-gray-50"
                        } shadow-lg`}
                    >
                  ...
                  {lessons.map((lesson) => (
                    ...
                    >
                      <div className="flex items-center mb-2">
                        ...
                        <Text
                          strong
                          className={`text-blue-500 text-lg ${isDarkMode ? "text-blue-400" : ""
                            }`}
                        >
                          {lesson.title}
                        </Text>
          ...
          <div className="space-y-6">
            ...
            >
              <Descriptions.Item label="Address">
                {selectedStudent.address ?? "No address"}
              </Descriptions.Item>
