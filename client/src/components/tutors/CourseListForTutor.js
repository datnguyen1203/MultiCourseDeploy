...
const CourseListForTutor = () => {
    ...
    const fetchTutorCourses = async () => {
      ...
      try {
        const response = await axios.get(
          "https://multicourseserver.onrender.com/api/courses/course-of-tutor",
          {
            headers: {
      ...
      onOk: async () => {
        try {
          const response = await axios.delete(
            `https://multicourseserver.onrender.com/api/courses/delete-course/${courseId}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleUpdateCourse = async (updatedCourse) => {
    try {
      ...
      const response = await axios.put(
        `https://multicourseserver.onrender.com/api/courses/update-course/${updatedCourse._id}`,
        updatedCourse,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUpdateImage = async (courseId, imageFile) => {
    ...
    try {
      const response = await axios.put(
        `https://multicourseserver.onrender.com/api/courses/update-course-image/${courseId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
